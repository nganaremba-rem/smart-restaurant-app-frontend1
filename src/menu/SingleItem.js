...
export default function SingleItem({
	...
	const itemRating = menuItem.averageRating;
	const numberOfRatings = menuItem.numberOfRatings;
	const description = menuItem.description;
	const spiciness = menuItem.spicinessLevel;
			...
			>
				<Box sx={{ display: "flex", flexDirection: "column", flex: 1 }}>
					<CardContent sx={{ flex: "1 0 auto" }}>
						<img src={isVeg} style={{ width: 20, height: 20 }} alt="icon" />
